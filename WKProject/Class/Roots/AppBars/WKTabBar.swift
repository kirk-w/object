...
class WKTabBar: UITabBar {
    ...
    lazy var animateImageView3: UIImageView = {
        ...
        let animateImageView = UIImageView(image: UIImage(named: "tab_qworld_fg_nor"))
        self.addSubview(animateImageView)
        return animateImageView
    }()

    lazy var animateImageView4: UIImageView = {
        
        let animateImageView = UIImageView(image: UIImage(named: "tab_recent_fg_nor"))
        self.addSubview(animateImageView)
        return animateImageView
    }()
    ...
    override init(frame: CGRect) {
        ...
        self.backgroundImage = UIImage.resizableImage(imageName: (kStatusBarHeight > 20) ? "tabbar_bg_X" : "tabbar_bg", edgeInsets: UIEdgeInsetsMake(0.1, 0, 0, 0))
    }
        ...
        for view in subviews {
            if view.isKind(of: NSClassFromString("UITabBarButton")!){
                ...
                case 3:
                    ...
                    break
                case 4:
                    self.animateImageView4.center = view.center
                    self.animateImageView4.frame.origin.y -= 5
...
extension WKTabBar {
    ...
    @objc func tabBarBtnAction(bar: UIControl) {
        ...
        case 0:
            ...
            self.animateImageView3.image = UIImage(named: "tab_qworld_fg_nor")
            self.animateImageView4.image = UIImage(named: "tab_recent_fg_nor")
            break
        case 1:
        ...
        case 4:
            ...
            self.animateImageView2.image = UIImage(named: "tab_see_fg_nor")
            self.animateImageView3.image = UIImage(named: "tab_qworld_fg_nor")
            self.animateImageView4.image = UIImage(named: "tab_recent_fg_press")
        default:
            break
        }
    }
