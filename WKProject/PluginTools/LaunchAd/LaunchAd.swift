...
public class LaunchAd:NSObject{
    ...
    @discardableResult
    @objc public class func create(waitTime: Int = 3, showEnterForeground: Bool = false, timeForWillEnterForeground: Double = 10, adNetRequest: ((LaunchAdView)->())? = nil) -> LaunchAdView {
    ...
    @discardableResult
    @objc public class func create(waitTime: Int = 3, customNotificationName: String?, adNetRequest: ((LaunchAdView)->())? = nil) -> LaunchAdView {
